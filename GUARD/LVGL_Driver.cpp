...
void Lvgl_Touchpad_Read( lv_indev_drv_t * indev_drv, lv_indev_data_t * data )
{
  ...
  if (touchpad_pressed && touchpad_cnt > 0) {
    // CST328 reports in portrait space (X: 0..239, Y: 0..319).
    // MADCTL=0x60 (MX=1, MV=1) rotates display 90° CW.
    // Transform touch to landscape LVGL space (320×240):
    //   lvgl_x = raw_y
    //   lvgl_y = (240 - 1) - raw_x
    data->point.x = touchpad_y[0];
    data->point.y = (240 - 1) - touchpad_x[0];
